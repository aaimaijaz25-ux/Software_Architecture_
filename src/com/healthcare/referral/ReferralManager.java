...
public class ReferralManager {
    ...
    private void generateEmailCommunication(Referral referral) {
        ...
        email.append("From: ").append(referral.getReferringFacilityID()).append("\n");
        email.append("To: ").append(referral.getReceivingFacilityID()).append("\n");
    ...
    public void generateReferralFile(Referral referral, String outputPath) {
        try (FileWriter writer = new FileWriter(outputPath)) {
            ...
            writer.write("Facility: " + referral.getReferringFacilityID() + "\n\n");

            writer.write("RECEIVING INFORMATION:\n");
            writer.write("Clinician ID: " + referral.getReceivingClinicianID() + "\n");
            writer.write("Facility: " + referral.getReceivingFacilityID() + "\n\n");
